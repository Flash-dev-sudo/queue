...
export class MemStorage implements IStorage {
  ...
  private async initializeData() {
    ...
    await this.createMenuItem({ name: "Fried Chicken Wings (3 pcs)", description: "", price: 150, mealPrice: 330, categoryId: 5, available: true, hasMealOption: true });
    await this.createMenuItem({ name: "Fried Chicken Wings (6 pcs)", description: "", price: 300, mealPrice: 480, categoryId: 5, available: true, hasMealOption: true });
    await this.createMenuItem({ name: "Fried Chicken Strips (3 pcs)", description: "", price: 200, mealPrice: 380, categoryId: 5, available: true, hasMealOption: true });
    await this.createMenuItem({ name: "Fried Chicken Strips (6 pcs)", description: "", price: 400, mealPrice: 580, categoryId: 5, available: true, hasMealOption: true });
    // Peri Peri options (meal and flavor options)
